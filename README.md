...
เข้าผ่าน **LINE login (LIFF)** — เปิด LIFF URL ใน LINE หรือกดปุ่มในเมนู session จะผูกกับบัญชีของคนนั้นเอง ต้องตั้ง `LIFF_ID` ก่อน การ login ไม่สร้างบัญชีให้ ต้องแอดบอทใน LINE ก่อนเสมอ

`DASHBOARD_PASSWORD` เป็นรหัสร่วม บอกไม่ได้ว่าใครเป็นใคร จึงใช้ได้เฉพาะตอนที่มีเจ้าของคนเดียว เหลือไว้แค่ให้ dev เข้าเครื่องตัวเอง
