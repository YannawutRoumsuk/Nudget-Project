...
> ข้อจำกัดที่รู้ตัว: หลายยอดใน**บรรทัดเดียวกัน** เช่น `บิล shoppe 3 เดือน 4050 3800 3800` ยังบันทึกแค่ยอดสุดท้าย (3800) เพราะแยกไม่ได้ว่าเป็นลิสต์หรือชื่อรายการ ให้ขึ้นบรรทัดใหม่แทน
