...
function helpOverview(): string {
	return [
		...
		'',
		'ดูเพิ่มเติม พิมพ์',
		'  วิธีใช้บันทึก · วิธีใช้สลิป · วิธีใช้เว็บ · วิธีใช้บิล · วิธีใช้คำสั่ง',
		'',
		'อยากถามต่อกับ AI พิมพ์ “ช่วยเหลือ”'
	].join('\n');
}
...
function helpWeb(): string {
	return [
		...
		'  ตั้งงบรายเดือน',
		'  ดูบิลที่ต้องจ่าย',
		'  ดูและแก้กฎหมวดหมู่ที่ระบบจำไว้',
...
function helpCommands(): string {
	return [
		...
		'ตั้งค่าเตือน — เปิด/ปิด เปลี่ยนเวลา เขตเวลา หรือวันเตือนบิลล่วงหน้า',
		'ฟีดแบ็ก — ส่งข้อความถึงผู้พัฒนา',
		'ถามยอดแบบภาษาคน — เช่น “อาทิตย์นี้กินข้าวไปเท่าไร” หรือ “เดือนนี้ค่าเดินทางเทียบเดือนก่อน”',
		'มีอะไรใหม่ — ดูอัปเดตล่าสุดของบอท',
		'',
		'พิมพ์ “วิธีใช้” เพื่อย้อนกลับไปหน้าแรก',
...
export function unknownText(text: string): string {
	...
	lines.push('ลองพิมพ์แบบนี้ดู', '  ข้าวเที่ยง 60', '  +เงินเดือน 30000', '', 'พิมพ์ “วิธีใช้” เพื่อดูวิธีใช้ทั้งหมด');
	return lines.join('\n');
}
...
export function aiHelpStartText(limit: number): string {
	return [
		'🤖 กำลังเข้าสู่โหมดช่วยเหลือกับ AI',
		'',
		'ถามวิธีใช้งาน Nudget ต่อได้เลย',
		`ใช้ได้ไม่เกิน ${limit} ครั้งต่อวัน เพื่อควบคุมค่าใช้จ่าย`,
		'บทสนทนาในโหมดนี้จะถูกบันทึกและมีเพียงแอดมินที่เปิดดูได้',
		'',
		'พิมพ์ “จบช่วยเหลือ” หรือ “ออก” เพื่อออกจากโหมด'
	].join('\n');
}

export function aiHelpEndText(): string {
	return 'ออกจากโหมดช่วยเหลือ AI แล้ว พิมพ์ “วิธีใช้” เพื่อดูคู่มือแบบเลือกหัวข้อได้ทุกเมื่อ';
}
